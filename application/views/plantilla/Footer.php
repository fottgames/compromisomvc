...
<!-- jQuery (necessary for Bootstrap's JavaScript plugins) -->
	...
	<script src="<?php echo base_url() ?>assets/template/vendor/bootstrap-select-1.12.2/dist/js/bootstrap-select.min.js"></script>
	<script src="<?php echo base_url() ?>assets/template/vendor/bootstrap-select-1.12.2/dist/js/i18n/defaults-es_CL.min.js"></script>
